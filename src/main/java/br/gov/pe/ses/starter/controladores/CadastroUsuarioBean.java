...
public class CadastroUsuarioBean implements Serializable {
	...
	private DualListModel<Hospital> dualListModelHospitais;
	private DualListModel<Perfil> dualListModelPerfis;
	List<Perfil> perfisDisponiveis;	
	List<Hospital> hospitaisDisponiveis;
	...
	public void inicializar() {		
		...
		usuario.setHospitaisAssociados(new ArrayList<Hospital>());
		...
		dualListModelHospitais = new DualListModel<Hospital>(hospitaisDisponiveis, usuario.getHospitaisAssociados());
	...
	public void onTransferHospital(TransferEvent event) {
		...
		List<Hospital> hospitaisMovimentados = (List<Hospital>) event.getItems();

		for (Hospital hospital : hospitaisMovimentados) {			
	...
	protected void listarPerfisDisponiveis() {		
		...
		if (hospitalSelecionado==null || hospitalSelecionado.getId()==null || usuario.getHospitaisAssociados().isEmpty()) {			
	...
	protected void listarHospitaisDisponiveis() {		
		...
		hospitaisDisponiveis = new ArrayList<Hospital>();
		
		List<Hospital> hospitais = hospitalService.listarHospitaisAtivos();
	...
	public void setarHospitalPadraoDoUsuario() {
		...
		usuario.setHospital(hospitalSelecionado);
