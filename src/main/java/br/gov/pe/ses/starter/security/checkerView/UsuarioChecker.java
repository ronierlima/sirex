...
@Component
@RequestScoped
public class UsuarioChecker {

    @Inject
    private ExternalContext externalContext;

    public boolean isPodeIncluir() {
        return temPermissao(Permissao.INCLUIR_USUARIO);
    }

    public boolean isPodeAlterar() {
        return temPermissao(Permissao.ALTERAR_USUARIO);
    }

    public boolean isPodeExcluir() {
        return temPermissao(Permissao.EXCLUIR_USUARIO);
    }

    public boolean isPodeVisualizar() {
        return temPermissao(Permissao.VISUALIZAR_USUARIO);
    }
