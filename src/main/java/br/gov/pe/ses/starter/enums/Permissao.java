...
public enum Permissao {
    ...
    EXCLUIR_TIPO_UNIDADE("TIPO_UNIDADE__EXCLUIR"),
    VISUALIZAR_TIPO_UNIDADE("TIPO_UNIDADE__VISUALIZAR"),

    // UNIDADES
    INCLUIR_UNIDADE("UNIDADE_INCLUIR"),
    ALTERAR_UNIDADE("UNIDADE_ALTERAR"),
    EXCLUIR_UNIDADE("UNIDADE__EXCLUIR"),
    VISUALIZAR_UNIDADE("UNIDADE__VISUALIZAR"),
